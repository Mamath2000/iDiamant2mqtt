        ...
        const gatewayPayload = {
            ...
            components: {
                ...
                [`idiamant_${device.name}_position`]: {
                    ...
                    name: "Position",
                    state_topic: `${stateTopic}/state`,
                    value_template: "{{ value_json.position|int(50) }}",
                    force_update: "true",
                    uniit_of_measurement: "%",
                    icon: "mdi:blinds-vertical",
                    has_entity_name: true
                },
                [`idiamant_${device.name}_is_open`]: {
                    ...
                    name: "Est ouvert",
                    state_topic: `${stateTopic}/state`,
                    value_template: "{{ 1 if (value_json.position|int(50) > 0) else 0 }}",
                    payload_on: 1,
                    payload_off: 0,
                    force_update: true,
                ...
                [`idiamant_${device.name}_last_seen`]: {
                    ...
                    value_template: '{{ as_datetime(value|int) }}',
                    device_class: 'timestamp',
                    icon: 'mdi:clock-outline'
                },
                ...
                [`idiamant_${device.name}_cover`]: {
                    ...
                    position_topic: `${stateTopic}/state`,
                    position_template: '{{ value_json.position|int(50) }}',
                    position_open: 100,
                    position_closed: 0,
                    payload_open: 'open',
                    payload_close: 'close',
